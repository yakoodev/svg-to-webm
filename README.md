...
Вкладка «Конструктор баннера» — готовый рекламный баннер (шаблон v3d), который меняется без кода:
...
Шаблон: `src/templates/v3d.js`, ассеты: `assets/v3d/`, шрифты: `assets/fonts/` (Unbounded и Manrope, OFL).
