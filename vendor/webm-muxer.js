/* webm-muxer 5.1.4 (MIT, github.com/Vanilagy/webm-muxer) — vendored with a small alpha patch, see PATCH below */
"use strict";
var WebMMuxer = (() => {
  ...
  var Muxer = class {
    ...
    addVideoChunkRaw(data, type, timestamp, meta) {
      ...
      // PATCH (svg-to-webm): meta.alphaData -> BlockAdditions/BlockMore(BlockAddID=1) for VP8/VP9 alpha
      let alphaAdd = meta && meta.alphaData ? [{ id: 166 /* BlockMore */, data: [{ id: 238 /* BlockAddID */, data: 1 }, { id: 165 /* BlockAdditional */, data: meta.alphaData }] }] : void 0;
      let videoChunk = __privateMethod(this, _createInternalChunk, createInternalChunk_fn).call(this, data, type, timestamp, VIDEO_TRACK_NUMBER, void 0, alphaAdd);
